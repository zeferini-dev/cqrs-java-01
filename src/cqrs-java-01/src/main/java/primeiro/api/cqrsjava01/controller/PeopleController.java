...
public class PeopleController {
    ...
    @GetMapping("/version")
    @Operation(summary = "Versão da API", description = "Retorna a versão da API", method = "GET")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Versão da API obtida com sucesso"),
